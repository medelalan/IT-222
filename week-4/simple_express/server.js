...
app.get('/repairService',function(req,res){ // When the user asks for the request which includeds the '/' path we render the following request:-
	res.render('repairService');
});

app.get('/ITService',function(req,res){ // When the user asks for the request which includeds the '/' path we render the following request:-
	res.render('ITService');
});

app.get('/sale',function(req,res){ // When the user asks for the request which includeds the '/' path we render the following request:-
	res.render('sale');
});
